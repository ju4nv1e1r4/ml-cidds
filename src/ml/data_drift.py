...
class DataDrift:
    ...
    def preprocess_current_data(self, df):
        ...
        common_ports = [20, 21, 22, 23, 25, 53, 67, 68, 69, 80, 110, 123, 143, 161, 443, 445, 993, 995]
        df['is_common_port'] = df['source_port'].astype(int).isin(common_ports).astype(int)
        ...
        selected_cols = [
            'duration', 'total_packets_used', 'bytes_flow',
            'bytes_per_packet', 'packets_per_seconds', 'hour_of_day',
            'is_common_port', 'has_SYN', 'has_ACK', 'has_RST', 'has_FIN'
        ]
